...
public class MatchStats : IEquatable<MatchStats>
{
    ...
    public override bool Equals(object? obj) => Equals(obj as MatchStats);
    ...
    public static bool operator ==(MatchStats? left, MatchStats? right) => EqualityComparer<MatchStats>.Default.Equals(left, right);
    public static bool operator !=(MatchStats? left, MatchStats? right) => !(left == right);
}
