...
public static class DependencyInjection
{
    public static IServiceCollection AddTFTAssistantCore(this IServiceCollection services)
    {
        ...
        services.AddSingleton<ChampionAnalysisService>();
        services.AddSingleton<LineupAnalysisService>();
        services.AddSingleton<MetaAnalysisService>();
        services.AddSingleton<WinRateStatisticsService>();
